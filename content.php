			...
			<?php } 
					...
					switch ($sel_page['id']) {
						...
						case 2:
							...
							width="396" border="0" alt="robot" align="left"><?php
							echo "<h2> {$sel_page['name']} </h2>";
						...
						case 3:
							...
							break;
						default:
							?><h2>Please select a robot</h2> 			
							<p><?php echo navigation($sel_robot);?></p><?php
							break;	} 
					echo "</div>";
					} 
					else {
							?><h2>Please select a robot</h2> 			
							<p><?php echo navigation();?></p><?php
					} ?>
			<br />
			<br />
		</td>
